...
workbook = xlsxwriter.Workbook('CHB_FL_VID_1.xlsx')
...
a.enable()
time.sleep(1)
print('0x30', a.dsh.i2c_read_reg(0x30))
...
for j in range(10):
    ...
    worksheet.write(0, 1 + 12 * j, '0x6B[3:2] = ' + data1[4:6])
    worksheet.write(0, 2 + 12 * j, '0x2B[3] = ' + data2[4])
    worksheet.write(0, 3 + 12 * j, '0x6D[1] = ' + data3[6])
